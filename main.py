...
def main():
    t = threading.Thread(target=audioFunc)
    t.start()
    ...
    print("                     __                .__   ")
    print("  ____  ____   _____/  |________  ____ |  |  ")
    print("_/ ___\/  _ \ /    \   __\_  __ \/  _ \|  |  ")
    print("\  \__(  <_> )   |  \  |  |  | \(  <_> )  |__")
    print(" \___  >____/|___|  /__|  |__|   \____/|____/")
    print("     \/           \/                         ")
    print("                     .__   __   ")
    print("              _____  |  |_/  |_ ")
    print("              \__  \ |  |\   __\\")
    ...
    print("                   \/           ")
    print("        .___     .__          __          ")
    print("      __| _/____ |  |   _____/  |_  ____  ")
    print("     / __ |/ __ \|  | _/ __ \   __\/ __ \ ")
    print("    / /_/ \  ___/|  |_\  ___/|  | \  ___/ ")
    print("    \____ |\___  >____/\___  >__|  \___  >")
    print("         \/    \/          \/          \/ \n")
